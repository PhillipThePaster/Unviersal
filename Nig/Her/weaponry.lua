...
SettingSection:AddColor({text = "Accent Color", flag = "Menu Accent Color", color = Color3.fromRGB(77, 166, 255), callback = function(color)
...
-- [Background List]
local back = SettingSection:AddList({text = "Background", max = 10, flag = "background", values = {"Maxwell", "WackyCreature", "AmongUs", "FloppaSurvior", "Cheese", "NeonFloppa","Astolfo","Astolfo2","Felix", "None"}, value = "None", callback = function(v)
...
-- [Tile Size Slider]
SettingSection:AddSlider({text = "Background Size", min = 50, max = 1000, value = 600, callback = function(size)
    if library.main then
